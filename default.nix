...
# with following call:
# >rix(r_ver = "7f2d0a352efa6695d91cdd6374d88ff0fc62b963",
#  > r_pkgs = c("devtools",
#  > "testthat",
#  > "pkgdown",
#  > "shinytest2",
...
#  > project_path = ".",
#  > overwrite = TRUE)
# It uses upstream nixpkgs' revision 7f2d0a352efa6695d91cdd6374d88ff0fc62b963 for reproducibility purposes
# which will install R version latest-upstream.
# Report any issues to https://github.com/ropensci/rix
let
 pkgs = import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/7f2d0a352efa6695d91cdd6374d88ff0fc62b963.tar.gz") {};
