        ...
        tagList(
          tags$li(style = "margin: 4px 0; line-height: 1.5;",
            ...
            if (length(parts) > 1) tagList(
              " \u2014 ",
              tags$span(style = "color: var(--neutral-secondary);",
  ...
  output$ir_help_panel <- renderUI({
    ...
    div(
      ...
      div(style = "flex: 1;",
        ...
        tags$p(style = "margin: 4px 0 0 0; color: var(--neutral-secondary);", info$summary)
      ),
  ...
  observeEvent(input$ir_help_example_btn, {
    ...
    showModal(modalDialog(
      ...
      div(
        ...
        tags$hr(),
        tags$p(style = "color: var(--neutral-tertiary); font-size: 12px;",
