...
source(
  paste0(
    Cerebro.options[["cerebro_root"]],
    "/viewer/hla_tcr_motifs/settings.R"
  ),
  local = TRUE
)
source(
...
source(
  paste0(
    Cerebro.options[["cerebro_root"]],
    "/viewer/hla_tcr_motifs/network_table.R"
  ),
  local = TRUE
)
source(
  paste0(
    Cerebro.options[["cerebro_root"]],
    "/viewer/hla_tcr_motifs/data_qc.R"
  ),
  local = TRUE
)
source(
  paste0(
    Cerebro.options[["cerebro_root"]],
    "/viewer/hla_tcr_motifs/associations.R"
  ),
  local = TRUE
)
source(
...
source(
  paste0(
    Cerebro.options[["cerebro_root"]],
    "/viewer/hla_tcr_motifs/help_guide.R"
  ),
  local = TRUE
)
