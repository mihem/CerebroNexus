...
#> [08:13:02] Initializing Cerebro object...
#> [08:13:02] Adding expression data (embedded)...
#> [08:13:02] Collecting available meta data...
#> [08:13:02] Extracting all meta data columns...
#> [08:13:02] Extracting dimensional reductions...
#> [08:13:02] Will export the following dimensional reductions: umap
#> [08:13:02] Extracting marker genes table...
#> [08:13:02] No trajectories to extract...
#> [08:13:02] Checking for spatial data...
#> [08:13:02] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 4.3.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-23
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [08:13:02] Saving Cerebro object to: /tmp/nix-shell-4428-1726610894/RtmpPtezZ7/pbmc_Seurat.crb
#> [08:13:02] Done!
```
