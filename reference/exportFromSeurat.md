...
#> [08:09:32] Initializing Cerebro object...
#> [08:09:32] Adding expression data (embedded)...
#> [08:09:32] Collecting available meta data...
#> [08:09:32] Extracting all meta data columns...
#> [08:09:32] Extracting dimensional reductions...
#> [08:09:32] Will export the following dimensional reductions: umap
#> [08:09:32] Extracting marker genes table...
#> [08:09:32] No trajectories to extract...
#> [08:09:32] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.2
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-21
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [08:09:32] Saving Cerebro object to: /tmp/nix-shell-4576-486387351/RtmpPWPcHC/pbmc_Seurat.crb
#> [08:09:32] Done!
```
