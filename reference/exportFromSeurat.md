...
#> [12:50:16] Initializing Cerebro object...
#> [12:50:16] Adding expression data (embedded)...
#> [12:50:16] Collecting available meta data...
#> [12:50:16] Extracting all meta data columns...
#> [12:50:16] Extracting dimensional reductions...
#> [12:50:16] Will export the following dimensional reductions: umap
#> [12:50:16] Extracting marker genes table...
#> [12:50:16] No trajectories to extract...
#> [12:50:16] Checking for spatial data...
#> [12:50:16] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 3.0.2
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-07-27
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [12:50:16] Saving Cerebro object to: /tmp/nix-shell-4279-3295617419/Rtmpv94a2l/pbmc_Seurat.crb
#> [12:50:16] Done!
```
