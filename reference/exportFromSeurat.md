...
#> [09:11:09] Initializing Cerebro object...
#> [09:11:09] Adding expression data (embedded)...
#> [09:11:09] Collecting available meta data...
#> [09:11:09] Extracting all meta data columns...
#> [09:11:09] Extracting dimensional reductions...
#> [09:11:09] Will export the following dimensional reductions: umap
#> [09:11:09] Extracting marker genes table...
#> [09:11:09] No trajectories to extract...
#> [09:11:09] Checking for spatial data...
#> [09:11:09] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 4.3.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-30
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [09:11:09] Saving Cerebro object to: /tmp/nix-shell-4443-4220139514/Rtmpr4QO9u/pbmc_Seurat.crb
#> [09:11:09] Done!
```
