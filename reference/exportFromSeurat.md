...
#> [14:27:10] Initializing Cerebro object...
#> [14:27:10] Adding expression data (embedded)...
#> [14:27:10] Collecting available meta data...
#> [14:27:10] Extracting all meta data columns...
#> [14:27:10] Extracting dimensional reductions...
#> [14:27:10] Will export the following dimensional reductions: umap
#> [14:27:10] Extracting marker genes table...
#> [14:27:10] No trajectories to extract...
#> [14:27:10] Checking for spatial data...
#> [14:27:10] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 4.1
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-08
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [14:27:10] Saving Cerebro object to: /tmp/nix-shell-4380-2983616268/RtmpkAy4VC/pbmc_Seurat.crb
#> [14:27:10] Done!
```
