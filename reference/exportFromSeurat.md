...
#> [18:34:43] Initializing Cerebro object...
#> [18:34:43] Adding expression data (embedded)...
#> [18:34:43] Collecting available meta data...
#> [18:34:43] Extracting all meta data columns...
#> [18:34:43] Extracting dimensional reductions...
#> [18:34:43] Will export the following dimensional reductions: umap
#> [18:34:43] Extracting marker genes table...
#> [18:34:43] No trajectories to extract...
#> [18:34:43] Checking for spatial data...
#> [18:34:43] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 4.4.2
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-09-09
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [18:34:43] Saving Cerebro object to: /tmp/nix-shell-4350-2118129695/RtmpLPTgUy/pbmc_Seurat.crb
#> [18:34:43] Done!
```
