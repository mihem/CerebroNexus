...
#> [19:20:14] Loading gene sets...
#> [19:20:14] Loaded 2 gene sets from GMT file.
#> [19:20:14] Extracting transcript counts from `data` slot of `RNA` assay...
#> [19:20:14] Performing analysis for 2 subgroups of group `sample`...
...
#> [19:20:14] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [19:20:14] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.4.7
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores
#> ✔ Calculations finished
#> [19:20:15] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
