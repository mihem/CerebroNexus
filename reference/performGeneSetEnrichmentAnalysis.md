...
#> [17:16:29] Loading gene sets...
#> [17:16:29] Loaded 2 gene sets from GMT file.
#> [17:16:29] Extracting transcript counts from `data` slot of `RNA` assay...
#> [17:16:29] Performing analysis for 2 subgroups of group `sample`...
...
#> [17:16:29] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [17:16:29] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.3
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [17:16:29] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
